...
if __name__ == "__main__":
    pass
    #bug = open("debug.log","a+")
    #message = open("email.txt","rb").read()
    #message = """From: greg@caerostris.net\r\nSubject: test\r\n message\r\n\r\nHi.\r\n\r\nWe lost the game. Are you hungry yet?\r\n\r\nJoe.\r\n"""
    #print rfc822_parse(message)
    #sig = sign(message, "_dkim", "caerostris.net", open("./dkim.key").read(),canonicalize=(Relaxed,Relaxed))
    #print sig
    #print verify(message,debuglog=bug)
